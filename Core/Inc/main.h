...
#define LED_MLOCAL_Pin GPIO_PIN_0
#define LED_MLOCAL_GPIO_Port GPIOA
#define LED_MSERIAL_Pin GPIO_PIN_1
#define LED_MSERIAL_GPIO_Port GPIOA
#define VCP_TX_Pin GPIO_PIN_2
#define VCP_TX_GPIO_Port GPIOA
#define LED_BSY_Pin GPIO_PIN_3
